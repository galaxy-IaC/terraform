...
# Cloud Watch Alarm trigger the above scaling policy when CPU Utilization is above 80%
# Send the notificaiton email to users present in SNS Topic Subscription
