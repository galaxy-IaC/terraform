...
# App3 - Private EC2 Instance
output "app3_ec2_private_instance_ids" {
  description = "List of IDs of app3 instances"
  value       = [for app3private in module.ec2_private_app3 : app3private.id]
}

output "app3_ec2_private_ip" {
  description = "List of private IP addresses assigned to the app3 instances"
  value       = [for app3private in module.ec2_private_app3 : app3private.private_ip]
}